...
public class Message {
    ...
    public Message(String from, String to, String subject, String text) { /* Remove whitespace */
        From = from.trim();
        To = to.trim();
...
// ensure that recipient address is not invalid
...
// ensure that sender address is not invalid
        if(!From.contains("@")){
            System.out.println("Sender address is invalid");
            return false;
        }

// ensure that the address is not invalid
        if(!To.contains("@")){
            System.out.println("Recipient address is invalid");
            return false;
        }
